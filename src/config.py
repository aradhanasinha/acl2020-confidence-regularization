...
GLUE_SOURCE = join(SOURCE_DIR, "MNLI")
MULTINLI_SOURCE = join(SOURCE_DIR, "MNLI/original")
MNLI_TEST_SOURCE = join(SOURCE_DIR, "MNLI/multinli_test")
MNLI_HARD_SOURCE = join(SOURCE_DIR, "MNLI/multinli_hard")

TEACHER_SOURCE = join("../teacher_preds", "bert_base_mnli_probs.json")
...
BIAS_PATHS = [
    ("hypo", "hyp_only.json"), ("hans_json", "lex_overlap_preds.json"),
    ...
    ("fever_claim_only_balanced",
     "weaker_balanced_duplicate_fever_claim_only.json"),
...
QQP_PAWS_PATHS = [("hans_0", "hans_0.json"), ("hans_100", "hans_100.json"),
                  ("hans_250", "hans_250.json"), ("hans_500", "hans_500.json"),
                  ("hans_1000", "hans_1000.json"),
                  ("hans_1500", "hans_1500.json"),
                  ("hans_2000", "hans_2000.json"),
                  ("hans_2500", "hans_2500.json")]
QQP_PAWS_PATHS += [("shallow_0", "qqp_shallow_0.json")]

QQP_PAWS_BIAS_SOURCES = {
    x[0]: join("../biased_preds/qqp_paws", x[1]) for x in QQP_PAWS_PATHS
}
QQP_PAWS_TEACHER_SOURCES = {
    x[0]: join("../teacher_preds/qqp_paws", x[1]) for x in QQP_PAWS_PATHS
}
